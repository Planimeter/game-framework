...
__attribute__ ((visibility("default"))) size_t aiGetExportFormatCount(void);
__attribute__ ((visibility("default"))) const struct aiExportFormatDesc* aiGetExportFormatDescription( size_t pIndex);
...
__attribute__ ((visibility("default"))) void aiReleaseExportFormatDescription( const struct aiExportFormatDesc *desc );
__attribute__ ((visibility("default"))) void aiCopyScene(const struct aiScene* pIn,
    struct aiScene** pOut);




__attribute__ ((visibility("default"))) void aiFreeScene(const struct aiScene* pIn);
__attribute__ ((visibility("default"))) aiReturn aiExportScene( const struct aiScene* pScene,
    const char* pFormatId,
    const char* pFileName,
    unsigned int pPreprocessing);
__attribute__ ((visibility("default"))) aiReturn aiExportSceneEx( const struct aiScene* pScene,
    const char* pFormatId,
    const char* pFileName,
    struct aiFileIO* pIO,
    unsigned int pPreprocessing );
...
__attribute__ ((visibility("default"))) const struct aiExportDataBlob* aiExportSceneToBlob( const struct aiScene* pScene, const char* pFormatId, unsigned int pPreprocessing );
...
__attribute__ ((visibility("default"))) void aiReleaseExportBlob( const struct aiExportDataBlob* pData );
struct aiFileIO;
struct aiFile;
...
__attribute__ ((visibility("default"))) const char* aiGetLegalString (void);
...
__attribute__ ((visibility("default"))) unsigned int aiGetVersionMinor (void);
...
__attribute__ ((visibility("default"))) unsigned int aiGetVersionMajor (void);
...
__attribute__ ((visibility("default"))) unsigned int aiGetVersionRevision (void);
__attribute__ ((visibility("default"))) unsigned int aiGetCompileFlags (void);
